...
public class TestRunner {
	...
	public TestRunner(Method publishMethod, Method observerMethod, Method setupMethod, Object testCase) {
	...
	public static void runTest(Class<?> testCaseClazz) throws InstantiationException, IllegalAccessException {
		...
		TestRunner runner = new TestRunner(publishMethod, observerMethod, setupMethod, test);
		runner.doTest();
	...
	protected void report() {
		...
		for (Map.Entry<Integer, ExpectInfo> entry : expectMap.entrySet()) {
			ei = entry.getValue();
			sbd.append("\n\rexpected:" + entry.getKey() + "		occurrences:" + ei.count() + "		==>" + ei.description);
		}
		sbd.append("\n\r=====================================END=============================================");
